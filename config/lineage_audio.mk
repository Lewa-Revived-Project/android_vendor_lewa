...
ALARM_PATH := vendor/lewa/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lewa/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lewa/prebuilt/common/media/audio/ringtones
